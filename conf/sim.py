...
def gen_inet_packet(size, src_mac, dst_mac, src_ip, dst_ip):
    ...
    udp = UDP(sport=10002, dport=10001)
...
def gen_ue_ntf_packet(size, src_mac, dst_mac, src_ip, dst_ip, inner_src_ip, inner_dst_ip, teid):
    ...
    payload = \
        ...
        b"\x61\x58\x49\x69\x4c\x43\x4a\x6c\x62\x6d\x4d\x69\x4f\x69\x4a\x42" \
        b"\x4d\x54\x49\x34\x51\x30\x4a\x44\x4c\x55\x68\x54\x4d\x6a\x55\x32" \
        b"\x49\x6e\x30\x2e\x2e\x69\x4c\x47\x43\x48\x56\x4d\x79\x5f\x6b\x61" \
        b"\x44\x68\x6c\x62\x53\x56\x45\x41\x75\x31\x41\x2e\x67\x50\x59\x48" \
        b"\x57\x49\x70\x49\x64\x6b\x4f\x5f\x33\x55\x68\x4c\x79\x51\x73\x72" \
        b"\x36\x47\x65\x30\x59\x36\x32\x4d\x67\x41\x70\x68\x52\x58\x59\x34" \
        b"\x7a\x41\x71\x4e\x73\x38\x68\x30\x6e\x76\x51\x36\x49\x39\x56\x64" \
        b"\x67\x46\x6f\x64\x75\x4b\x59\x67\x6c\x46\x33\x5f\x4d\x71\x70\x63" \
        b"\x47\x4a\x56\x77\x6a\x52\x4c\x5a\x33\x61\x63\x64\x66\x4e\x48\x6e" \
        b"\x68\x30\x55\x50\x72\x6e\x64\x64\x6b\x6f\x4c\x6e\x6e\x4b\x32\x6e" \
        b"\x58\x39\x52\x63\x48\x5a\x59\x2e\x57\x50\x71\x41\x70\x75\x75\x46" \
        b"\x79\x4f\x31\x34\x75\x47\x51\x52\x4e\x77\x53\x78\x39\x51" \
        b"\x00\x00" \
